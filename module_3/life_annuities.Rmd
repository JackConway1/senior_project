...
2. Use the *presentValue* function to compute the APV of a whole life annuity for (30) with payments of $1000 at the beginning of every year. Use the soa08 data table from the *lifecontingencies* package.